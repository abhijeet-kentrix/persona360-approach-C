...
export const KentrixFiltersDescription = [{'ID': 3,
 ...
 {'ID': 7,
  'Group': 'Socio-Economic Profile',
  'Category': 'Income',
  'SubCategory': 'Premium Buyers (Above ₹2.3L)',
  'Description(Facebook)': 'Consumer is living in an urban area, where the monthly household-level income is typically High” (INR > 2,30,000). ',
  'FilterDescription': 'Demographic information such as Affluence and income are provided in these segments.',
  'PopUpInfoIconDescription': 'Consumer is living in an urban area, where the monthly household-level income is typically High” (INR > 2,30,000). ',
  'OneLiner': ''},
 {'ID': 9,
  'Group': 'Consumer Segments',
  'Category': 'Lifestyle',
